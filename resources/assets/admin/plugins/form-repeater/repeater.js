jQuery.fn.extend({
    createRepeater: function(options = {}) {
      ...
      $('.repeater-show-btn').on('click', function() {
        $('.repeater-section').show();
        $('.req').attr('required', 'required');
        $('.repeater-heading').removeClass('d-none');
        $('.repeater-show-heading').remove();
    });
      ...
      $(".old_remove-btn").attr("onclick", "$(this).parents('.old_items').remove()");
