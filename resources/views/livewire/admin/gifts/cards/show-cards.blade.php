...
<tr>
    ...
    <td>
         <a href="{{ getImage($item->image) }}" target="_blank">
            <img src="{{ getImageThumb($item->image) }}" alt="" width="100">
        </a> 
    </td>
    ...
    <td>
        <div class="d-flex justify-content-center">
            ...
            <a  title="@lang('admin.show')" href="{{ route('admin.gifts.cards.show', $item->id) }}" class="btn btn-neutral text-info btn-sm m-1"><i class="bx bx-show-alt"></i></a>


            <a title="@lang('admin.edit')" href="{{ route('admin.gifts.cards.edit', $item->id) }}"   class="btn btn-neutral text-primary btn-sm m-1"><i class="bx bxs-edit"></i></a>
