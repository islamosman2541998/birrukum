<tr>
    ...
    <td>
        @if($item->decease)
            <a data-hover="@lang('admin.show')" href="{{ route('admin.deceases.request.show', $item->decease?->id) }}" class="btn btn-neutral text-info"><i class="bx bxs-show"></i></a>
        @endif
    </td>
    ...
    <td>
        <div class="d-flex justify-content-center">
            ...
            <a data-hover="@lang('admin.show')" href="{{ route('admin.deceases.projects.show', $item->id) }}" class="btn btn-neutral text-info" wire:click="show({{ $item->id }})"><i class="bx bxs-show"></i></a>


            <a data-hover="@lang('admin.edit')" href="{{ route('admin.deceases.projects.edit', $item->id) }}" class="btn btn-neutral text-primary"><i class="bx bxs-edit"></i></a>
            {{-- <a data-hover="@lang('admin.review')" href="{{ route('admin.deceases.project.reviews',$item->id) }}" class="btn btn-neutral text-warning"><i class="bx bx-comment-dots""></i></a> --}}
