                            ...
                            <tr>
                                ...
                                <td>
                                    @switch($order->payment_method_id)
                                        @case(3)
                                            <a href="{{ getImage($order->banktransferproof) }}" target="_blank"
                                                class="btn btn-primary btn-sm py-0">
                                                {{ $order->paymentMethod?->trans_ar->title }}
                                                <i class="bx bx-download bx-xs"></i>
                                            </a>
                                            <span
                                                class="btn btn-outline-primary btn-sm py-0">{{ @$order->payment_method_key }}</span>
                                        @break

                                        @case(2)
                                            <a>
                                                {{ $order->paymentMethod?->trans_ar->title }}<i
                                                    class="bx bx-credit-card bx-xs"></i>
                                            </a>
                                        @break
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @switch($order->shipping_status)
                                            ...
                                            @case('picked')
                                                <span class="btn btn-outline-info btn-sm py-0"> {{ $order->shipping_status }}
                                                </span>
                                            @break

                                            @case('delivering')
                                                <span class="btn btn-outline-primary btn-sm py-0">
                                                    {{ $order->shipping_status }} </span>
                                            @break

                                            @case('delivered')
                                                <span class="btn btn-outline-success btn-sm py-0">
                                                    {{ $order->shipping_status }} </span>
                                            @break

                                            @case('canceled')
                                                <span class="btn btn-outline-danger btn-sm py-0"> {{ $order->shipping_status }}
                                                </span>
                                            @break
                                        ...
                                        @forelse ($Orderdetails['App\Models\CharityProject'] as $details)
                                            ...
                                            @if (@$showGift[$details->id] == 1)
                                                ...
                                                <tr class="bg-lightBlue">
                                                    ...
                                                    <td></td>
                                                    <td>
                                                        <a href="{{ getImage($giftCard->image) }}" target="_blank">
                                                            <img src="{{ getImage($giftCard->image) }}" width="30px"
                                                                alt="" class="rounded">
                                                        </a>
                                                    </td>
