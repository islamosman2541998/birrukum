        ...
        <div class="border rounded accordion-item">
            ...
            <div id="collapseSetting" class="accordion-collapse collapse show" aria-labelledby="headingSetting" data-bs-parent="#accordionExampleSetting">
                <div class="accordion-body">
                    ...
                    <div class="col-12">
                        <div class="mb-3 row">
                            <label for="example-number-input" class="col-sm-12 col-form-label"> @lang('charityProject.number') </label>
                            <div class="col-sm-12">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-12">
                            <select class="form-select " name="project_types" required wire:model="project_types" wire:change.prevent="updateProjectTypes($event.target.value)">
                                ...
                                <option value="{{ $key}}" {{ $project_types ?? old('project_types') == $key ? 'selected': '' }}>
                                    {{ $type }}
                                </option>
                                @endforeach
                            </select>
                    ...
                    <div class="mb-3 row title-section">
                        <label for="example-text-input" class="col-sm-12 col-form-label"> @lang('charityProject.category') {{-- <span class="text-danger">*</span> --}}</label>
                        <div class="col-sm-12">
                            <select class="form-select form-select-sm select2 {{ (empty($errors->first('category_id'))) ?: 'has-error'  }}" name="category_id" wire:model.prevent="category_id" aria-label=".form-select-sm example" required>
                                <option value="" selected>@lang('charityProject.choose_category')
                                </option>
                                @foreach ($categories as $item)
                                <option value="{{ $item->id }}" {{ $category_id ?? old('category_id') == $item->id ? 'selected' : '' }}>
                    ...
                    <div class="mb-3 row title-section">
                        ...
                        <div  wire:ignore  class="col-sm-12">
                            <select class="form-select form-select-sm select2 {{ (empty($errors->first('tags'))) ?: 'has-error'  }}" multiple name="tags[]" wire.model.prevent="tags" aria-label=".form-select-sm example">
                                <option value="" disabled>@lang('charityProject.choose_tag')</option>
                                @foreach ($projectTags as $item)
                                <option value="{{ $item->id }}" {{ in_array($item->id, @$tags ?? old('tags')) ?
                                            'selected' : '' }}>
                                    {{ $item->trans->where('locale', $current_lang)->first()->title }}
                                </option>
                                @endforeach
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-12">
                            <select class="form-select " name="type" required wire:model="type" wire:change.prevent="updateType($event.target.value)" required>
                                ...
                                <option value="{{ $key}}" {{ ($type ?? old('type')) == $key ? 'selected': '' }}>
                                    {{ $type }}
                                </option>
                                @endforeach
                            </select>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-12">
                                    <input class="form-control {{ (empty($errors->first('sort'))) ?: 'has-error'}}" type="number" id="example-sort-input" name="sort" value="{{ old('sort') ?? 0 }}">
                                    @if ($errors->has('sort'))
            ...
            <div id="payment_method" class="accordion-collapse collapse show" aria-labelledby="headingPayments" data-bs-parent="#accordionExamplePayments">
                <div class="accordion-body">
                    ...
                    <div class="mb-3 row title-section">
                        ...
                        <div class="col-sm-12">
                            <select class="form-select form-select-sm" name="donation_type" wire:model="donation_type" aria-label=".form-select-sm example" id="denation-type" required>
                                ...
                                <option value="{{ $key }}" {{ $key == ($donation_type ?? old('donation_type')) ? 'selected' : '' }}>
                                    {{ $value }}</option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="mb-3 mt-3 row">
                        <div class="col-12">
                            ...
                            <div class="col-sm-12">
                                <input class="form-control {{ (empty($errors->first('target_price'))) ?: 'has-error'}}" type="number" id="example-target_price-input" name="target_price" value="{{ old('target_price') ?? 0 }}">
