<tr>
    ...
    <td>
        <div class="d-flex justify-content-center">
            ...
            <a data-hover="@lang('admin.show')" href="{{ route('admin.charity.projects.show', $item->id) }}" class="btn btn-neutral text-info" wire:click="show({{ $item->id }})"><i class="bx bxs-show"></i></a>

            <a data-hover="@lang('admin.edit')" href="{{ route('admin.charity.projects.edit', $item->id) }}" class="btn btn-neutral text-primary"><i class="bx bxs-edit"></i></a>
            <a data-hover="@lang('admin.review')" href="{{ route('admin.charity.project.reviews', $item->id) }}" class="btn btn-neutral text-warning"><i class="bx bx-comment-dots""></i></a>
