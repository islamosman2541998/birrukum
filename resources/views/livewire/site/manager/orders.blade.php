            ...
            <div class="donation">
                <div class="px-0 mx-0">
                    ...
                    <div class="d-flex flex-column flex-md-row" dir="rtl">
                        <div class="col-md-3 text-center text-md-end col-12">
                            <h1 class="fs-4"> @lang('Orders List') </h1>

                        </div>

                        <div class="col-md-3 text-center text-md-end col-12 px-2">
                            <select class="form-control" wire:model="selectedRefer" wire:change="search">
                                <option value="">@lang('All')</option>
                                @forelse ($refers as $refer)
                                    <option value="{{ $refer->id }}" {{$refer->id  == $selectedRefer ? 'selected' : '' }}>
                                        {{ $refer->name }}
                                    </option>
                                @empty
                                @endforelse
                        ...
                        <div class="col-md-3 text-center col-12">
                            <div class="dropdown mx-auto">
                                <select class="form-control" wire:model="selectedStatus" wire:change="search">
                                    <option value="">@lang('All')</option>
                        ...
                        <table class="col-12 shadow table text-center align-content-center table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <th scope="row">{{ $order['referrer_name'] }}</th>
                                    ...
                                    <td>
                                        @livewire('site.manager.orders-items', ['order_id' => $order['id']], key( $order['id']))
                                    </td>
                                </tr>
                                @empty
                                @endforelse
