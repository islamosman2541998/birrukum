...
<div class="col-12 order-lg-1 order-1 col-lg-3">
    ...
    <div class="row border-main my-4 mx-3 bg-white">
        ...
        <div class="col-12 meun-li p-3 {{ Route::is('site.managers.index') ? 'active' : '' }} ">
        ...
        <div class="col-12  meun-li p-3 {{ Route::is('site.managers.orders.index') ? 'active' : '' }}">
            <a href="{{ route('site.managers.orders.index') }}">
            <div class="row py-2 justify-content-center align-content-center">
                <div class="col-2">
