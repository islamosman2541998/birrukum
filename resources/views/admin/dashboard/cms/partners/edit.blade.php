        ...
        <form action="{{ route('admin.partners.update', $partner->id) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                                ...
                                <div id="collapsePartner{{ $key }}" class="accordion-collapse collapse show mt-3" aria-labelledby="headingPartner{{ $key }}" data-bs-parent="#accordionExamplePartner{{ $key }}">
                                    <div class="accordion-body">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-12">
                                                <input class="form-control" type="text" name="{{ $locale }}[title]" value="{{ @$partner->trans->where('locale', $locale)->first()->title }}">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-12 mb-2">
                                                <textarea name="{{ $locale }}[description]" class="form-control" rows="5">{{ @$partner->trans->where('locale', $locale)->first()->description }}</textarea>
                                ...
                                <div class="accordion-body">
                                    ...
                                    @if($partner->image)
                                        <div class="col-sm-4 mb-3">
                                            <a href="{{ getImage($partner->image) }}" target="_blank">
                                                <img src="{{ getImageThumb($partner->image) }}" alt="" style="width:100%">
                                            </a>
                                        </div>
                                    @endif
                                    ...
                                    <div class="col-12">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-12">
                                                <input class="form-control" type="text" name="url" value="{{ @$partner->url }}" placeholder="https://example.com">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-12">
                                                <input class="form-control" type="number" name="sort" value="{{ @$partner->sort }}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 mt-3">
                                        <div class="col-sm-10">
                                            <div class="form-check form-switch form-check-success">
                                                ...
                                                <input class="form-check-input" type="checkbox" role="switch" name="status" {{ @$partner->status == 1 ? 'checked' : '' }} id="partnerStatus">
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="row mb-3 text-end">
                    <div>
                        <a href="{{ route('admin.partners.index') }}" class="btn btn-outline-danger waves-effect waves-light ml-3 btn-sm">@lang('button.cancel')</a>
