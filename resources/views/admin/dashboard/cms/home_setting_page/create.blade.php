                    ...
                    <form action="{{ route('admin.home-settings.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                                        ...
                                        <div id="collapseOne{{ $key }}" class="accordion-collapse collapse show mt-3" aria-labelledby="headingOne{{ $key }}" data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                ...
                                                <div class="row mb-3 title-section">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" id="title{{ $key }}" name="{{ $locale }}[title]" value="{{ old($locale . '.title') }}" class="form-control title">
                                            ...
                                            <div class="accordion-body">
                                                ...
                                                <div class="col-12">
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input class="form-control" type="text" placeholder="@lang('settings.setting_name_section')" id="example-number-input" name="title_section" value="{{ old('title_section') }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                {{-- url ------------------------------------------------------------------------------------- --}}
                                                <div class="col-12">
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input class="form-control" type="text" placeholder="@lang('settings.url')" id="example-number-input" name="url" value="{{ old('url') }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                {{-- image ------------------------------------------------------------------------------------- --}}
                            ...
                            <div class="row mb-3 text-end">
                                <div>
                                    <a href="{{ route('admin.home-settings.index') }}" class="btn btn-outline-primary waves-effect waves-light ml-3 btn-sm">@lang('button.cancel')</a>
