                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.ads.update') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    @foreach($items as $key => $ad)
                                        <div class="ads mt-3">
                                            ...
                                            <div class="col-12 text-center">
                                                <button  type="button"  class="btn btn-danger delete_ads form-control"><i class="bx bxs-trash"></i></button>
                                            </div>
                                        </div>
                                        <hr>
                                    @endforeach
                        ...
                        <div class="row mb-3 text-end">                                
                            <div>
                                <a href="{{ route('admin.articles.index') }}" class="btn btn-outline-danger waves-effect waves-light ml-3">@lang('button.cancel')</a>
                ...
                $('#ads_section').append(
                    ...
                    <div>
                        <div class="ads">
                            ...
                            <div class="col-12">
                                <button class="btn btn-danger delete_ads form-control"><i class="bx bxs-trash"></i></button>
                            </div>
                        <hr>
