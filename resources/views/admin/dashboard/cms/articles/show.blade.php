            ...
            <div class="col-md-8">
                        ...
                        <div id="collapseTitle{{ $key }}" class="accordion-collapse collapse show mt-3" aria-labelledby="headingTitle{{ $key }}" data-bs-parent="#accordionExampleTitle{{ $key }}">
                            <div class="accordion-body">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" name="{{ $locale }}[title]" disabled value="{{ @$article->trans->where('locale',$locale)->first()->title}}" id="title{{ $key }}">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3 slug-section">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="{{ $locale }}[slug]" disabled value="{{ @$article->trans->where('locale',$locale)->first()->slug}}" id="slug{{ $key }}" class="form-control slug" required>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10 mb-2">
                                        <p>{!! @$article->trans->where('locale',$locale)->first()->description !!}</p>
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10 mb-2">
                                        <p>{!! @$article->trans->where('locale',$locale)->first()->content !!}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="accordion mt-4 mb-4" id="accordionExampleMeta">
                    <div class="accordion-item border rounded">
                        ...
                        <div id="collapseMeta{{ $key }}" class="accordion-collapse collapse  mt-3" aria-labelledby="headingTwo{{ $key }}" data-bs-parent="#accordionExampleMeta">
                            <div class="accordion-body">
                                @foreach ($languages as $key => $locale)
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" name="{{ $locale }}[meta_title]" disabled value="{{ @$article->trans->where('locale',$locale)->first()->meta_title}}" id="title{{ $key }}">
                                    </div>
                        ...
                        <div id="collapseSetting" class="accordion-collapse collapse show" aria-labelledby="headingSetting" data-bs-parent="#accordionExampleSetting">
                            <div class="accordion-body">
                                ...
                                <div class="col-12 mb-3">
                                        <label for="example-number-input" class="col-sm-3 col-form-label"> @lang('categories.category')</label>
                                        <span>{{ $article->categories?->trans->where('locale',$current_lang)->first()->title }}</span>
                                </div>
                                {{-- tags ------------------------------------------------------------------------------------- --}}
                                <div class="col-12">
                                    <div class=" mb-3">
                                            <label for="example-number-input" class="col-sm-3 col-form-label"> @lang('tags.tags')</label>
                                ...
                                <div class="col-12">
                                    <div class=" mb-3">
                                        <label class="col-sm-3 col-form-label"> @lang('articles.sort')</label>
