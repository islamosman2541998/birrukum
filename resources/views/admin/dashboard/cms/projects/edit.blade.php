                                ...
                                <div class="accordion-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 image-select mt-2">
                                            @if( @$img->url!= null)
                                            <input type="hidden" name="old_image[image][]" value="{{ $img->url }}" id="">
                                            <input type="hidden" name="old_image[id][]" value="{{ $img->id }}" id="">
                                            <span class="btn btn-danger bx bx-x  delete-image">  </span>
                                            @endif
                            ...
                            <div id="collapseTwo" class="accordion-collapse collapse show" aria-labelledby="headingTwo" data-bs-parent="#accordionExampleTwo">
                                <div class="accordion-body">
                                    <div class="col-sm-3 col-md-6 mb-3">
                                        <a href="{{ getImage($project->image) }}"target="_blank">
                                            <img src="{{ getImageThumb($project->image) }}" alt="" style="width:100%">
                                        </a>
                                    </div>
                                    {{-- image ------------------------------------------------------------------------------------- --}}
                                    <div class="col-12">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-12">
                                                <select class="form-select" name="portfolio_id">
                                                    <option value="" disabled selected> {{ trans('admin.please_select') }}</option>
                                    ...
                                    <div class="col-12">
                                        <div class="col-sm-10 mt-3">
                                            <div class="form-check form-switch form-check-success">
                                                ...
                                                <input class="form-check-input" type="checkbox" role="switch" name="status" {{  @$project->status == 1 ? 'checked' : '' }} id="flexSwitchCheckSuccessStatus">
                                            </div>                                            
                                        </div>
                                    </div>
                                </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('.image-select').on('click', '.delete-image', function(e) {
