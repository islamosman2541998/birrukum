                                            ...
                                            @forelse (json_decode(@$settings['gift_category']) as $key =>$item)
                                                <div class="row new-gift-field mb-2 item_{{ $key }}">
                                                    ...
                                                    <div class="col-md-5">
                                                        ...
                                                        <div class="glr-group row">
                                                            ...
                                                            <a data-toggle="modal" href="javascript:;"
                                                                ...
                                                                class="mt-2 ml-3 btn btn-primary waves-effect waves-light btn-sm"
                                                                type="button">@lang('admin.choose')</a>
                                                        </div>
                                                                ...
                                                                <div class="modal-content">
                                                                    <div class="pt-0 mt-0 card-body">
                                                                        <iframe width="100%" height="500"
                                                                            src="{{ asset('backend/filemanager/dialog.php') }}?type=2&field_id=group{{ $key }}&relative_url=1"
                                                                            frameborder="0"
                                                    ...
                                                    <div class="col-md-1 mt-5">
                                                        <a class="text-danger h3 fa-lg remove-row"
                                                    ...
                                                    <div class="col-md-10 mb-2">
                                                        <div class="row">
                                                            ...
                                                            @forelse($images as $img)
                                                                <div class="col-md-1">
                                                                    <a href="{{ getImageFileManger($img) }}"
                                                                        target="_blank">
                                                                        <img class="img-fluid"
                                                                            src="{{ getImageFileManger($img) }}"
                                                                            alt="">
                                                                    </a>
                                                                </div>
                                                            @empty
