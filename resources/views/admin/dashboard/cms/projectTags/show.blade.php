...
@section('title', trans('projectTags.show'))
@section('title_page', trans('projectTags.show', ['name' => @$project_tag->trans->where('locale',$current_lang)->first()->title]) )
            ...
            <div class="row">
                <div class="col-12 m-3">
                    ...
                    <div class="row mb-3 text-end">
                        <div>
                            <a href="{{ route('admin.project-tags.index') }}"
                                                        ...
                                                        <div class="accordion-body">
                                                            ...
                                                            {{-- title ------------------------------------------------------------------------------------- --}}
                                                                <div class="row mb-3">
                                                                    ...
                                                                    <div class="col-sm-10"> 
                                                                        <input class="form-control" type="text" name="{{ $locale }}[title]" disabled  value="{{ $project_tag->trans->where('locale',$locale)->first()->title }}" id="title{{ $key }}">
                                                                    </div>
                                                            ...
                                                            {{-- slug ------------------------------------------------------------------------------------- --}}
                                                                <div class="row mb-3 slug-section">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input type="text" name="{{ $locale }}[slug]"disabled value="{{ $project_tag->trans->where('locale',$locale)->first()->slug}}" id="slug{{ $key }}"
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-10 mb-2">
                                                                    <textarea id="description{{ $key }}" name="{{ $locale }}[description]" disabled> {{ $project_tag->trans->where('locale',$locale)->first()->description }} </textarea>
                                                        ...
                                                        @foreach ($languages as $key => $locale)
                                                            ...
                                                            {{-- meta_title_ ------------------------------------------------------------------------------------- --}}
                                                                <div class="row mb-3">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input class="form-control" type="text" name="{{ $locale }}[meta_title]"  disabled value="{{$project_tag->trans->where('locale',$locale)->first()->meta_title }} }}" id="title{{ $key }}">
                                                                    </div>
                                                                ...
                                                                <div class="row mb-3">
                                                                    ...
                                                                    <div class="col-sm-10 mb-2">
                                                                        <textarea name="{{ $locale }}[meta_description]" class="form-control description" disabled> {{ $project_tag->trans->where('locale',$locale)->first()->meta_description }} </textarea>
                                                                ...
                                                                <div class="row mb-3">
                                                                    ...
                                                                    <div class="col-sm-10 mb-2">
                                                                        <textarea  name="{{ $locale }}[meta_key]" class="form-control description" disabled> {{ $project_tag->trans->where('locale',$locale)->first()->meta_key }} </textarea>
                                            ...
                                            <div class="accordion-item border rounded">
                                                ...
                                                <div id="collapseOne" class="accordion-collapse collapse show"
                                                    ...
                                                    <div class="accordion-body">
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input class="form-control" type="number"
                                                                        ...
                                                                        value="{{ $project_tag->sort }}" disabled>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        {{-- feature ------------------------------------------------------------------------------------- --}}
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input class="form-check form-switch" name="feature"
                                                                    type="checkbox" id="switch1" switch="success"
                                                                     value="1" {{ @$project_tag->feature == 1? 'checked':'' }} disabled>
                                                        ...
                                                        <div class="col-12">
                                                            <label class="col-sm-12 col-form-label"
                                                                for="available">{{ trans('projectTags.back_home') }}</label>
                                                            <div class="col-sm-10">
                                                                <input class="form-check form-switch" name="back_home"
                                                                    type="checkbox" id="switch2" switch="success"
                                                                    value="1" {{ @$project_tag->back_home == 1? 'checked':'' }} disabled>
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input class="form-check form-switch" name="status"
                                                                    type="checkbox" id="switch3" switch="success"
                                                                     value="1" {{ @$project_tag->status == 1? 'checked':'' }} disabled>
                                                    ...
                                                    <div class="accordion-body">
                                                        ...
                                                        <div class="col-12">
                                                            <div class="row mb-3">
                                                                ...
                                                                <input type="text" name="background_color" value="{{$project_tag->background_color}}"disabled placeholder="#212529" class="form-control spectrum with-add-on colorpicker-showinput-intial" id="colorpicker-showinput-intial" >
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
