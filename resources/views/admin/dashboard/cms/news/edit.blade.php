                                    ...
                                    <div class="row mb-3 slug-section">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-12 mb-2">
                                                <textarea id="description{{ $key }}" name="{{ $locale }}[description]" class="form-control" rows="5" cols="100"> {{ @$news->trans->where('locale',$locale)->first()->description }} </textarea>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-12 mb-2">
                                                <textarea id="content{{ $key }}" name="{{ $locale }}[content]"> {{ @$news->trans->where('locale', $locale)->first()->content }} </textarea>
                            ...
                            <div id="collapseSetting" class="accordion-collapse collapse show" aria-labelledby="headingSetting" data-bs-parent="#accordionExampleSetting">
                                <div class="accordion-body">
                                    <div class="col-sm-3 mb-3">
                                        <a href="{{ getImage( $news->image) }}" target="_blank">
                                            <img src="{{ getImageThumb( $news->image ) }}" alt="" style="width:100%">
                                        </a>
                                    </div>
                                    {{-- image ------------------------------------------------------------------------------------- --}}
                                    <div class="col-12">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="col-sm-10 mt-3">
                                            <div class="form-check form-switch form-check-success">
                                                ...
                                                <input class="form-check-input" type="checkbox" role="switch" name="feature" {{   @$news->feature == 1 ? 'checked' : '' }} id="flexSwitchCheckSuccessFeature">
                                            </div>
                                        </div>
                                    </div>
                                    {{-- news_ticker ------------------------------------------------------------------------------------- --}}
                                    ...
                                    <div class="col-12">
                                        <div class="col-sm-10 mt-3">
                                            <div class="form-check form-switch form-check-success">
                                                ...
                                                <input class="form-check-input" type="checkbox" role="switch" name="status" {{  @$news->status == 1 ? 'checked' : '' }} id="flexSwitchCheckSuccessStatus">
                                            </div>
                                        </div>
                                    </div>
                                </div>
