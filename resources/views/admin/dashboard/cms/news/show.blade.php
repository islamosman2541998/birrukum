                        ...
                        <div id="collapseTitle{{ $key }}" class="accordion-collapse collapse show mt-3" aria-labelledby="headingTitle{{ $key }}" data-bs-parent="#accordionExampleTitle{{ $key }}">
                            <div class="accordion-body">
                                ...
                                <div class="row mb-3 slug-section">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="{{ $locale }}[slug]" disabled value="{{ @$news->trans->where('locale',$locale)->first()->slug}}" id="slug{{ $key }}" class="form-control slug" required>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10 mb-2">
                                        <p>{!! @$news->trans->where('locale',$locale)->first()->description !!}</p>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10 mb-2">
                                        <p>{!! @$news->trans->where('locale',$locale)->first()->content !!}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="accordion-item border rounded">
                        ...
                        <div id="collapseSetting" class="accordion-collapse collapse show" aria-labelledby="headingSetting" data-bs-parent="#accordionExampleSetting">
                            <div class="accordion-body">
                                ...
                                {{-- sort ------------------------------------------------------------------------------------- --}}
                                <div class="col-12">
                                    <label for="example-number-input" class="col-sm-6 col-form-label"> @lang('articles.sort')</label>
                                    <span>{{ $news->sort }}</p>
                                </div>
                                {{-- feature ------------------------------------------------------------------------------------- --}}
                                <div class="col-12 ">
                                ...
                                {{-- news_ticker ------------------------------------------------------------------------------------- --}}
                                <div class="col-12">
                                    <label class="col-sm-6 col-form-label" for="available">{{ trans('admin.news_ticker') }}</label>
                                    @if($news->news_ticker == 1 )
                                    <span class="badge bg-success">@lang("admin.yes")</span>
                                    @else
                                    <span class="badge bg-danger">@lang("admin.no")</span>
                                    @endif
