...
@section('title', trans('products.showCategory', ['name' => @$item->translate($locale)->title]))
...
<div class="container-fluid">
    <div class="row">
        <div class="col-12 m-3">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.eccommerce.categories.update', $item->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        <div class="row">
                            <div class="col-md-8">
                                    ...
                                    <div class="accordion-item border rounded">
                                        ...
                                        <div id="collapseSetting" class="accordion-collapse collapse show" aria-labelledby="headingSetting" data-bs-parent="#accordionExampleSetting">
                                            <div class="accordion-body">
                                                ...
                                                <div class="col-12  my-2">
                                                    <div class="row mb-3">
                                                        <label> @lang('admin.background_image')</label>
                                                        @if ($item->bcakground_image != null)
                                                        <img src="{{ getImageThumb($item->bcakground_image) }}" style="width:100%">
                                                        @endif
                                                    </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <select class="form-select form-select-sm select2" name="parent_id" disabled>
                                                                <option value="" selected disabled>   {{ trans('categories.select_parent') }}</option>
                                                ...
                                                <div class="col-12">
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-12">
                                                            <input class="form-control" type="number" name="sort" disabled value="{{ @$item->sort }}">
                                                        </div>
                                                        @error('sort')
                                                        <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                            ...
                            <div class="row mb-3 text-end">
                                <div>
                                    <a href="{{ route('admin.eccommerce.categories.index') }}" class="btn btn-outline-primary waves-effect waves-light ml-3">@lang('button.cancel')</a>
