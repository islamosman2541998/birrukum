...
@section('title_page', trans('tags.edit_tags', ['name' => @$tag->trans->where('locale',
        ...
        <div class="row">
            <div class="col-12 m-3">
                <div class="row mb-3 text-end">
                    <div>
                        <a href="{{ route('admin.eccommerce.tags.index') }}" class="btn btn-primary waves-effect waves-light ml-3 btn-sm">@lang('button.cancel')</a>
                    </div>
                </div>
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.eccommerce.tags.update', $tag->id) }}" method="post" enctype="multipart/form-data" id="form-submit">
                            @csrf
                            @method('put')
                            <div class="row">
                                <div class="col-md-8">
                                            ...
                                            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                                <div class="accordion-body">
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input class="form-check form-switch" name="feature" type="checkbox" id="switch1" switch="success" value="1" {{ @$tag->feature == 1 ? 'checked' : '' }}>
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input class="form-check form-switch" name="back_home" type="checkbox" id="switch2" switch="success" value="1" {{ @$tag->back_home == 1 ? 'checked' : '' }}>
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input class="form-check form-switch" name="status" type="checkbox" id="switch3" switch="success" value="1" {{ @$tag->status == 1 ? 'checked' : '' }}>
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-sm-12">
                                                            <a href="{{ getImage($tag->background_image) }}" target="_blank">
                                                                <img src="{{ getImageThumb($tag->background_image) }}" alt="" style="width:100%">
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div class="row mb-3 text-end">
                                <div>
                                    <a href="{{ route('admin.eccommerce.tags.index') }}" id="chiledBack" class="btn btn-primary waves-effect waves-light ml-3 btn-sm">@lang('button.cancel')</a>
