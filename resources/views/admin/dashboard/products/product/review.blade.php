            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body  search-group">
                        ...
                        {{-- Start Form search --}}
                        <form action="{{ route('admin.eccommerce.reviews', $product->id) }}" method="get">
                            <div class="row mb-3">
                                ...
                                <div class="search-input col-md-2">
                                    ...
                                    <a class="btn btn-success btn-sm"
                                        href="{{ route('admin.eccommerce.reviews', $product->id) }}"
                    ...
                    <div class="card-body mt-0 pt-0">
                        <form id="update-pages" action="{{ route('admin.eccommerce.reviews.actions') }}" method="post">
                            @csrf
                        </form>
                            ...
                            <table id="main-datatable"
                                ...
                                <tbody>
                                    @forelse ($reviews as $key => $item)
                                        <tr>
                                            ...
                                            <td>
                                                <div class=" d-flex justify-content-center">
                                                    @if ($item->status == 1)
                                                        <a href="{{ route('admin.eccommerce.reviews.update-status', $item->id) }}"
                                        ...
                                        @include('admin.dashboard.products.product.delete')
                                    @empty
                                    @endforelse
                                </tbody>
                            </table>
