...
@section('title_page', trans('attribute.edit', ['name' => @$items->trans->where('locale',$current_lang)->first()->title]) )
            ...
            <div class="col-12 m-3">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.eccommerce.attributes-set.update', $items->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            <div class="row">
                                <div class="col-md-9">
                                            ...
                                            <div class="accordion-body">
                                                ...
                                                <div class="col-12">
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-12">
                                                            <input class="form-control" type="number" name="sort" value="{{ $items->sort }}">
                                                        </div>
                                                        @error('sort')
                                                ...
                                                <div class="row mb-3 title-section">
                                                    <label for="example-text-input" class="col-sm-12 col-form-label">@lang('attribute.display_layout')</label>
                                                    <div class="col-sm-12">
                                                        <select class="form-select form-select-sm" name="display_layout" aria-label=".form-select-sm example">
                                                            <option value="">@lang('attribute.display_layout')</option>
                                                            @foreach (App\Enums\AttributesSetEnum::values() as $display_layout)
                                                            <option value="{{ $display_layout }}" {{ $display_layout == $items->display_layout ? 'selected' : '' }}>
                                                                {{ $display_layout }}</option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <div class="row col-12">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input class="form-check form-switch" name="status" type="checkbox" id="switch3" switch="success" {{ @$items->status == 1 ? 'checked' : '' }} value="1">
                                                ...
                                                {{-- feature ------------------------------------------------------------------------------------- --}}
                                                <div class="row col-12">
                                                    <label class="col-md-6" for="example-number-input" for="available">{{ trans('categories.feature') }}</label>
                                                    <div class="col-sm-6">
                                                        <input class="form-check form-switch" name="feature" type="checkbox" id="switch1" switch="success" {{ @$items->feature == 1 ? 'checked' : '' }} value="1">
                                                ...
                                                {{-- is_searchable ------------------------------------------------------------------------------------- --}}
                                                <div class="row col-12">
                                                    <label class="col-md-6" for="example-number-input" for="available">{{ trans('attribute.is_searchable') }}</label>
                                                    <div class="col-sm-6">
                                                        <input class="form-check form-switch" name="is_searchable" type="checkbox" id="switch4" switch="success" {{ @$items->is_searchable == 1 ? 'checked' : '' }} value="1">
