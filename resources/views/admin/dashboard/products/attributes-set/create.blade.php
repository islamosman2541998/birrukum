...
@section('title', trans('attribute.create'))
@section('title_page', trans('attribute.create'))
            ...
            <div class="col-12 m-3">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.eccommerce.attributes-set.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-9">
                                        ...
                                        <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                ...
                                                <div class="row mb-3 title-section">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <select class="form-select form-select-sm" name="display_layout" aria-label=".form-select-sm example">
                                                            ...
                                                            <option value="{{ $display_layout }}" {{ $display_layout == old('kafara') ? 'selected' : '' }}>
                                                ...
                                                <div class="row col-12">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input class="form-check form-switch" name="is_searchable" type="checkbox" id="switch4" switch="success" {{ old('is_searchable') == 1 ? 'checked' : '' }} value="1">
