...
@section('title', trans('gifts.create_category'))
...
<div class="card">
    <div class="card-body">
        ...
        <form action="{{ route('admin.gifts.categories.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-9">
                ...
                <div class="row mb-3 text-end">
                    <div>
                        <a href="{{ route('admin.gifts.categories.index') }}" class="btn btn-outline-primary waves-effect waves-light ml-3 btn-sm">@lang('button.cancel')</a>
