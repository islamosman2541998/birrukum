...
<div class="card">
    <div class="card-body">
        <form action="{{ route('admin.charity.single-projects.store') }}" method="post" enctype="multipart/form-data" id="form-submit">
            @csrf
            <div>
                <div class="row">
                    <div class="col-md-8">
                                ...
                                <div id="collapseTitle{{ $key }}" class="mt-3 accordion-collapse collapse show" aria-labelledby="headingTitles{{ $key }}" data-bs-parent="#accordionExampleTitle{{ $key }}">
                                    <div class="accordion-body">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-12">
                                                <input class="form-control {{ (empty($errors->first($locale . '.title'))) ?: 'has-error'  }}" type="text" name="{{ $locale }}[title]" value="{{ old($locale . '.title') }}" id="title{{ $key }}" required>
                                        ...
                                        <div class="mb-3 row slug-section">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" id="slug{{ $key }}" name="{{ $locale }}[slug]" value="{{ old($locale . '.slug') }}" class="form-control slug {{ (empty($errors->first($locale . '.slug'))) ?: 'has-error'  }}" required> 
                        ...
                        <div class="mt-4 mb-4 accordion" id="accordionExampleMeta">
                            <div class="border rounded accordion-item">
                                <h2 class="accordion-header" id="headingMeta{{ $key }}">
                                    <button class="accordion-button fw-medium collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseMeta{{ $key }}" aria-expanded="true" aria-controls="collapseTwo{{ $key }}">
                                        @lang('admin.meta')
                                    </button>
                                </h2>
                                ...
                                <div id="collapseSetting" class="accordion-collapse collapse show" aria-labelledby="headingSetting" data-bs-parent="#accordionExampleSetting">
                                    <div class="accordion-body">
                                        ...
                                        <div class="mb-3 row title-section">
                                            ...
                                            <div class="col-sm-12">
                                                <select class="form-select form-select-sm select2 {{ (empty($errors->first('category_id'))) ?: 'has-error'  }}" name="category_id" aria-label=".form-select-sm example" required>
                        ...
                        <div class="mt-4 mb-4 accordion" id="accordionExamplePublish">
                            <div class="border rounded accordion-item">
                                <h2 class="accordion-header" id="headingPublish">
                                    <button class="accordion-button fw-medium collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#settings_post" aria-expanded="true" aria-controls="settings_post">
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        <div class="m-auto row ">
                                            ...
                                            <div class="col-sm-6 mt-3">
                                                ...
                                                <div class="form-check form-switch form-check-success">
                                                    <input class="form-check-input {{ (empty($errors->first('hidden'))) ?: 'has-error'}}" type="checkbox" role="switch" name="single[hidden]" {{   old('single.hidden') == "on" ? 'checked' : '' }} id="flexSwitchCheckSuccessHidden">
                                            ...
                                            <div class="col-sm-6 mt-3">
                                                ...
                                                <div class="form-check form-switch form-check-success">
                                                    <input class="form-check-input {{ (empty($errors->first('mobile_confirmation'))) ?: 'has-error'}}" type="checkbox" role="switch" name="single[mobile_confirmation]" {{  old('single.mobile_confirmation') == "on" ? 'checked' : '' }} id="flexSwitchCheckSuccessmobile_confirmation">
                                            ...
                                            <div class="col-sm-6 mt-3">
                                                ...
                                                <div class="form-check form-switch form-check-success">
                                                    <input class="form-check-input {{ (empty($errors->first('gift'))) ?: 'has-error'}}" type="checkbox" role="switch" name="single[gift]" {{  old('single.gift') == "on" ? 'checked' : '' }} id="gift">
                                                    @if ($errors->has('gift'))
                                            ...
                                            <div class="mb-3 mt-2 row gift_card_title" >
                                                @foreach ($languages as $key => $locale)
                                                ...
                                                <div class="col-sm-12">
                                                    <input class="form-control " type="text" name="single[{{ $locale }}][gift_title]" value="{{ old('single.' . $locale . '.gift_title') }}" id="gift_title{{ $key }}" required>
                                                </div>
                                ...
                                <div id="payment_method" class="accordion-collapse collapse show" aria-labelledby="headingPayments" data-bs-parent="#accordionExamplePayments">
                                    <div class="accordion-body">
                                        ...
                                        <div class="mb-3 row title-section">
                                            ...
                                            <div class="col-sm-12">
                                                <select class="form-select form-select-sm" name="donation_type" aria-label=".form-select-sm example" id="denation-type" required >
                ...
                <div class="row mb-3 text-end">
                    <div>
                        <a href="{{ route('admin.charity.single-projects.index') }}" class="btn btn-outline-primary waves-effect waves-light ml-3 btn-sm" id="chiledBack">@lang('button.cancel')</a>
