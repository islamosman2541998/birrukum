...
@section('title', trans('store.show_store'))
@section('title_page', trans('store.show', ['name' => @$store->trans->where('locale', $current_lang)->first()->title]))
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="accordion mt-4 mb-4" id="accordionExample">
                                            <div class="accordion-item border rounded">
                                                ...
                                                <div id="collapseTwo5" class="accordion-collapse collapse show mt-3"
                                                    ...
                                                    <div class="accordion-body">
                                                        ...
                                                        <div class="row">
                                                            <div class="col">
                                                                ...
                                                                <div class="form-outline">
                                                                    <label class="form-label"
                                                                        for="form8Example1">@lang('users.name')</label>
                                                                    <input type="text" id="form8Example1"
                                                                        class="form-control @error('full_name') is-invalid @enderror"
                                                                        value="{{ @$store->full_name }}" name="full_name"
                                                                        disabled />
                                                            ...
                                                            <div class="col">
                                                                ...
                                                                <div class="form-outline">
                                                                    <label class="form-label"
                                                                        for="form8Example2">@lang('users.email')
                                                                    </label>
                                                                    <input type="email" id="form8Example2"
                                                                        class="form-control @error('email') is-invalid @enderror"
                                                                        value="{{ @$store->email }}" name="email"
                                                                        disabled />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col">
                                                                ...
                                                                <div class="form-outline">
                                                                    <label class="form-label"
                                                                        for="form8Example3">@lang('users.mobile')</label>
                                                            ...
                                                            <div class="col">
                                                                ...
                                                                <div class="form-outline">
                                                                    <label class="form-label"
                                                                        for="form8Example4">@lang('users.whatsapp')</label>
                                                                    <input type="text" id="form8Example4"
                                                                        class="form-control @error('whatsapp') is-invalid @enderror"
                                                                        disabled value="{{ @$store->whatsapp }}"
                                                                        name="whatsapp" />
                                                                </div>
                                                            </div>
                                                            <div class="col-md-12 mt-1">
                                                                ...
                                                                <div class="form-outline">
                                                                    <label class="form-label"
                                                                        for="form8Example5">@lang('users.password')</label>
                                                                    <input type="text" id="form8Example5" name="password"
                                                        ...
                                                        <div class="row">
                                                            <div class="col">
                                                                ...
                                                                <div class="form-outline">
                                                                    <label class="form-label"
                                                                        for="form8Example3">@lang('store.employee_name')</label>
                                                                    <input type="text" id="form8Example3"
                                                                        name="employee_name"
                                                                        class="form-control @error('employee_name') is-invalid @enderror"
                                                                        disabled value="{{ @$store->employee_name }}" />
                                                            ...
                                                            <div class="col">
                                                                ...
                                                                <div class="form-outline">
                                                                    <label class="form-label"
                                                                        for="form8Example4">@lang('store.employee_number')</label>
                                                                    <input type="text" id="form8Example4"
                                                                        class="form-control @error('employee_number') is-invalid @enderror"
                                                                        disabled value="{{ @$store->employee_number }}"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-6">
                                                                ...
                                                                <div class="form-outline">
                                                                    <label class="form-label"
                                                                        for="form8Example3">@lang('store.department')</label>
                                                                    <input type="text" id="form8Example3"
                                                                        name="department"
                                                                        class="form-control @error('department') is-invalid @enderror"
                                                                        disabled value="{{ @$store->department }}" />
                                                            ...
                                                            <div class="col-6">
                                                                ...
                                                                <div class="form-outline">
                                                                    <label class="form-label"
                                                                        for="form8Example4">@lang('store.ax_store_number')</label>
                                                                    <input type="text" id="form8Example4"
                                                                        class="form-control @error('ax_store_number') is-invalid @enderror"
                                                                        value="{{ @$store->ax_store_number }}" disabled
                                                                        name="ax_store_number" />
                                                                </div>
                                                            </div>
                                                            <div class="col-6">
                                                                <!-- Name input -->
                                                                <div class="form-outline">
                                                                    <label class="form-label"
                                                                        for="form8Example3">@lang('store.jop')</label>
                                                                    <input type="text" id="form8Example3" disabled
                                                                        name="jop"
                                                            ...
                                                            <div class="col-6">
                                                                ...
                                                                <div class="form-outline">
                                                                    <label class="form-label"
                                                                        for="form8Example4">@lang('store.location')</label>
                                                                    <input type="text" id="form8Example4"
                                                                        class="form-control" name="location"
                                                                        class="form-control @error('location') is-invalid @enderror"
                                                                        disabled value="{{ @$store->location }}" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input class="form-control" type="text"
                                                                        name="{{ $locale }}[title]"
                                                                        value="{{ @$store->trans->where('locale', $locale)->first()->title }}"
                                                            ...
                                                            <div class="row mb-3 slug-section">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" id="slug{{ $key }}"
                                                                        disabled name="{{ $locale }}[slug]"
                                                                        value="{{ @$store->trans->where('locale', $locale)->first()->slug }}"
                                                                ...
                                                                <div class="row mb-3 mt-3">
                                                                    ...
                                                                    <div class="col-sm-10 mb-2">
                                                                        <textarea id="description{{ $key }}" disabled name="{{ $locale }}[description]"> {{ @$store->trans->where('locale', $locale)->first()->description }} </textarea>
                                                    ...
                                                    <div class="accordion-body">
                                                        ...
                                                        @foreach ($languages as $key => $locale)
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input class="form-control" type="text"
                                                                        ...
                                                                        value="{{ @$store->trans->where('locale', $locale)->first()->meta_title }}"
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-10 mb-2">
                                                                    <textarea name="{{ $locale }}[meta_description]" class="form-control description" disabled> {{ @$store->trans->where('locale', $locale)->first()->meta_description }}</textarea>
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-10 mb-2">
                                                                    <textarea name="{{ $locale }}[meta_key]" class="form-control description" disabled> {{ @$store->trans->where('locale', $locale)->first()->meta_key }}</textarea>
                                    ...
                                    <div id="collapseOne2" class="accordion-collapse collapse show"
                                        ...
                                        <div class="accordion-body">
                                            ...
                                            @if ($store->employee_image != null)
                                                ...
                                                <img src="{{ getImageThumb($store->employee_image) }}" alt=""
                                                    style="width:100%">
                                            @endif
                                            @if ($store->background_image != null)
                                                <label for="example-number-input" col-form-label>
                                                    @lang('tags.image_background')</label>
                                                <img src="{{ getImageThumb($store->background_image) }}" alt=""
                                                    style="width:100%">
                                            @endif
                                            {{-- image Background ------------------------------------------------------------------------------------- --}}
                                            ...
                                            <div class="col-12">
                                                <div class="row mb-3">
                                                    <label for="example-number-input" col-form-label>@lang('tags.color_background')
                                                        :</label>
                                                    <input type="text" name="backgeound_color"
                                                        value="{{ @$store->background_color }}" disabled
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-check form-switch" name="status" type="checkbox"
                                                        disabled {{ @$store->status == 1 ? 'checked' : '' }}
