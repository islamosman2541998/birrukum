...
@section('title', trans('store.create_store'))
@section('title_page', trans('store.create_store'))
@section('style')
            ...
            <div class="row">
                <div class="col-12 m-3">
                    ...
                    <div class="card">
                                                    ...
                                                    <div class="accordion-body">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-12 mt-1">
                                                                ...
                                                                <div class="form-outline">
                                                                    <label class="form-label"
                                                                        for="form8Example5">@lang('store.employee_image')</label>
                                                                    <input type="file" id="form8Example5"
                                                                        name="employee_image"
                                            ...
                                            <div class="col-12">
                                                <div class="row mb-3">
                                                    ...
                                                    <input type="text" name="backgeound_color"
                                                        value="{{ old('background_color') }}" placeholder="#212529"
                        ...
                        <div class="row mb-3 text-end">
                            <div>
                                <a href="{{ route('admin.store.index') }}" id="chiledBack"
                                    class="btn btn-outline-primary waves-effect waves-light ml-3 btn-sm">@lang('button.cancel')</a>
