            ...
            <div class="col-md-8">
                ...
                <div class="accordion mt-4 mb-4" id="accordionExampleMeta{{ $key }}">
                    <div class="accordion-item border rounded">
                        ...
                        <div id="collapseMeta{{ $key }}" class="accordion-collapse collapse mt-3" aria-labelledby="headingTwo{{ $key }}" data-bs-parent="#accordionExampleMeta{{ $key }}">
                            <div class="accordion-body">
                        ...
                        <div id="collapseSetting" class="accordion-collapse collapse show" aria-labelledby="headingSetting" data-bs-parent="#accordionExampleSetting">
                            <div class="accordion-body">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-12">
                                        <input class="form-control" name="project_types" disabled type="text" value="{{ $items->project_types }}">
                                    </div>
                                </div>
                                {{-- category ------------------------------------------------------------------------------------- --}}
                                <div class="row mb-3 title-section">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <span class="badge rounded-pill bg-primary">{{ $category->trans->where('locale', $current_lang)->first()->title }}</span>
                                        @empty
                                        @endforelse
                                        {{-- <div class="col-sm-12">
                                ...
                                <div class="row mb-3">
                                    <label class="col-sm-12 col-form-label" for="available">@lang('charityProject.type') </label>
                                    <div class="col-sm-12">
                                        <input class="form-control" name="type" disabled type="text" value="{{ $items->type }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-check">
                                            ...
                                            <div class="col-md-12">
                                                <span class="badge bg-success">{{ $payment->trans->where('locale', $current_lang)->first()->title }}</span>
                                            </div>
                                            @endforeach
                                        </div>
                                    </div>
                        ...
                        <div id="payment_method" class="accordion-collapse collapse show" aria-labelledby="headingPayments" data-bs-parent="#accordionExamplePayments">
                            <div class="accordion-body">
                                ...
                                <div class="row mb-3 title-section">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="col-sm-12">
                                            <input class="form-control" type="text" id="example-number-input" name="kafara" disabled
