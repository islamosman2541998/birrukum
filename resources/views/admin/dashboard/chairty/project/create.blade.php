...
<div class="card">
    <div class="card-body">
        <form action="{{ route('admin.charity.projects.store') }}" method="post" enctype="multipart/form-data" id="form-submit">
            @csrf
            <div>
                <div class="row">
                    <div class="col-md-8">
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        <div class="mt-3 d-flex ">
                                            <div class="form-check form-switch form-check-success">
                                                <input class="form-check-input {{ (empty($errors->first('recurring'))) ?: 'has-error'}}" type="checkbox" role="switch" name="recurring" {{  old('recurring') == "on" ? 'checked' : '' }} id="recurring">
                                        ...
                                        <div class="mb-3 row title-section">
                                            ...
                                            <div class="col-sm-12">
                                                <select class="form-select form-select-sm select2 {{ (empty($errors->first('location_type'))) ?: 'has-error'  }}" name="location_type" >
                                        ...
                                        <div class="mb-3 row title-section">
                                            ...
                                            <div class="col-sm-12">
                                                <select class="form-select form-select-sm select2 {{ (empty($errors->first('categories'))) ?: 'has-error'  }}" multiple name="categories[]" >
                                                    {{-- <option value="" selected disabled>@lang('charityProject.choose_category')   </option> --}}
                                        ...
                                        {{-- tags ------------------------------------------------------------------------------------- --}}
                                        <div class="mb-3 row title-section">
                                            <label class="col-sm-12 col-form-label">@lang('charityProject.tags')</label>
                                            <div class="col-sm-12">
                                                <select class="form-select form-select-sm select2 {{ (empty($errors->first('tags'))) ?: 'has-error'  }}" multiple name="tags[]" >
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        <div class="m-auto row ">
                                            ...
                                            <div class="col-sm-6 mt-3">
                                                ...
                                                <div class="form-check form-switch form-check-success">
                                                    <input class="form-check-input {{ (empty($errors->first('fast_donation'))) ?: 'has-error'}}" type="checkbox" role="switch" name="finished" {{  old('fast_donation') == "on" ? 'checked' : '' }} id="flexSwitchCheckSuccessfast_donation">
                                ...
                                <div id="payment_method" class="accordion-collapse collapse show" aria-labelledby="headingPayments" data-bs-parent="#accordionExamplePayments">
                                    <div class="accordion-body">
                                        ...
                                        <div class="mb-3 row title-section">
                                            ...
                                            <div class="col-sm-12">
                                                <select class="form-select form-select-sm" name="donation_type"  id="denation-type">
                ...
                <div class="row mb-3 text-end">
                    <div>
                        <a href="{{ route('admin.projects.index') }}" class="btn btn-outline-primary waves-effect waves-light ml-3 btn-sm" id="chiledBack">@lang('button.cancel')</a>
