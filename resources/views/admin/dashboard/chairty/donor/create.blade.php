...
@section('title', trans('donors.create_donors'))
...
<div class="card">
    <form action="{{ route('admin.donors.store') }}" method="post" enctype="multipart/form-data" id="form-submit">
        @csrf
                    ...
                    <div class="border rounded accordion-item">
                        ...
                        <div id="collapseAccount" class="mt-3 accordion-collapse collapse show" aria-labelledby="headingAccount" data-bs-parent="#accordionAccount">
                            <div class="accordion-body">
                                <livewire:admin.accounts.create :passwordShow="false" />
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 mt-3">
                                        ...
                                        <select name="refer_id" class="form-control">
                                            ...
                                            <option value="{{ $refer->id }}" @if(old('refer_id') == $refer->id) selected @endif>
                                                {{ $refer->name }}
                                            </option>
                                            @empty
                                            @endforelse
                                    ...
                                    <div class="col-6 mt-3">
                                        ...
                                        <div class="form-check form-switch form-check-success">
                                            <input class="form-check-input {{ (empty($errors->first('status'))) ?: 'has-error'}}" type="checkbox" role="switch" name="mobile_confirm" {{  request('mobile_confirm') == 1 ? 'checked' : '' }} id="flexSwitchCheckSuccessConfirm">
                                            @if ($errors->has('status'))
                                            <span class="missiong-spam">{{ $errors->first('status') }}</span>
                                            @endif
                                        </div>
                        ...
                        <div id="collapseOne3" class="accordion-collapse collapse show mt-3" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                <div class="row">
                                    <div class="col-md-12" id="repeater">
                                        ...
                                        <div class="items" data-group="addressList">
                                            ...
                                            <div class="col-md-12">
                                                <div class="item-content">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <input type="text" class="form-control" data-name="city">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="example-email-input" class="col-sm-2 col-form-label">{{ trans('donors.country') }}</label>
                                                        <div class="col-lg-12">
                                                            <input type="text" class="form-control" data-name="country">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="example-email-input" class="col-sm-2 col-form-label">{{ trans('donors.address') }}</label>
                                                        <div class="col-lg-12">
                                                            <textarea class="form-control" data-skip-name="false" data-name="address"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="pull-right repeater-remove-btn mt-2">
                                                <button class="btn btn-danger remove-btn"> @lang('admin.delete')</button>
                                            </div>
                                            <hr>
                                            <div class="clearfix"></div>
                                        </div>
                                    ...
                                    <!-- Repeater Heading -->
                                    <div class="repeater-heading mt-3">
                                        <div class="col-md-12">
