...
@section('title', trans('refer.create_refer'))
...
<div class="card">
    <div class="card-body">
        <form action="{{ route('admin.charity.refers.store') }}" method="post" enctype="multipart/form-data" id="form-submit">
            @csrf
                                ...
                                <div class="accordion-body">
                                    <div class="row mb-3">
                                        <div class="col-6">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control @error('name') is-invalid @enderror" type="text" name="name" value="{{ old('name') }}" id="name-slug">
                                                @error('name')
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control @error('slug') is-invalid @enderror" type="text" name="slug" value="{{ old('slug') }}" id="slug">
                                                @error('slug')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                ...
                                <div class="accordion-body">
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control @error('employee_name') is-invalid @enderror" type="text" name="employee_name" value="{{ old('employee_name') }}">
                                                @error('employee_name')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control @error('employee_number') is-invalid @enderror" type="text" name="employee_number" value="{{ old('employee_number') }}">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control @error('employee_department') is-invalid @enderror" type="text" name="employee_department" value="{{ old('employee_department') }}">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control @error('ax_store_name') is-invalid @enderror" type="text" name="ax_store_name" value="{{ old('ax_store_name') }}">
                                                @error('ax_store_name')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control phone @error('whatsapp') is-invalid @enderror" type="tel" name="whatsapp" value="{{ old('whatsapp') }}">
                                                @error('whatsapp')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-sm-6 mt-3">
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input class="form-control @error('employee_image') is-invalid @enderror" type="file" name="employee_image" value="{{ old('employee_image') }}">
