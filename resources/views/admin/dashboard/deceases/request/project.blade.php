<div class="card">
    <div class="card-body">
        <form action="{{ route('admin.deceases.projects.store') }}" method="post" enctype="multipart/form-data">

            @csrf
            <div class="row">
                <input class="form-control" type="hidden" id="example-number-input" name="deceases[deceased_id]" value="{{ @$decease->id}}">
