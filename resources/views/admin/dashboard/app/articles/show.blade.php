                        ...
                        <div id="collapseTitle{{ $key }}" class="accordion-collapse collapse show mt-3" aria-labelledby="headingTitle{{ $key }}" data-bs-parent="#accordionExampleTitle{{ $key }}">
                            <div class="accordion-body">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" name="{{ $locale }}[title]" disabled value="{{ @$article->trans->title}}" id="title{{ $key }}">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3 slug-section">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="{{ $locale }}[slug]" disabled value="{{ @$article->trans->slug}}" id="slug{{ $key }}" class="form-control slug" required>
                                    </div>
                                </div>
                        ...
                        <div id="collapseSetting" class="accordion-collapse collapse show" aria-labelledby="headingSetting" data-bs-parent="#accordionExampleSetting">
                            <div class="accordion-body">
                                ...
                                <div class="col-12 mb-3">
                                        ...
                                        <span>{{ $article->section?->trans->title }}</span>
                                </div>
