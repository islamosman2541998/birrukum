...
@section('title', trans('sections.show_sections'))
@section('title_page', trans('sections.sections'))
@section('title_route', route('admin.app.articles.index') )
@section('button_page')
<a href="{{ route('admin.app.sections.create') }}" class="btn btn-outline-success btn-sm">@lang('admin.create')</a>
@endsection
...
<div class="row">
    ...
    <div class="card">
        <div class="card-body  search-group">
            {{-- Start Form search --}}
            <form action="{{route('admin.app.sections.index')}}" method="get">
                <div class="row mb-3">
                    ...
                    <div class="search-input col-md-2">
                        ...
                        <a class="btn btn-success btn-sm" href="{{route('admin.app.sections.index')}}" data-hover="{{ trans('button.reset') }}"><i class="bx bx-refresh"></i></a>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form id="update-pages" action="{{route('admin.app.sections.actions')}}" method="post">
                @csrf
            </form>
                ...
                <table id="main-datatable" class="table table-bordered text-center table-striped table-table-success table-hover table-sm" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                {{ substr(removeHTML($item->trans?->description?? ''),0,30) }}
                            ...
                            <td>
                                <div class="d-flex justify-content-center">
                                    @if($item->status == 1)
                                    <a href="{{ route('admin.app.sections.update-status', $item->id )}}" data-hover="@lang('admin.active')" class="btn btn-neutral text-success"><i class="bx bxs-check-square"></i></a>
                                    @else
                                    <a href="{{ route('admin.app.sections.update-status', $item->id )}}" data-hover="@lang('admin.dis_active')" class="btn btn-neutral text-secondary"><i class="bx bx-no-entry"></i></a>
                                    @endif

                                    @if($item->feature == 1)
                                    <a href="{{ route('admin.app.sections.update-featured', $item->id )}}" data-hover="@lang('admin.feature')" class="btn btn-neutral text-warning"><i class="bx bxs-star"></i></a>
                                    @else
                                    <a href="{{ route('admin.app.sections.update-featured', $item->id )}}" data-hover="@lang('admin.feature')" class="btn btn-neutral text-secondary"><i class="bx bxs-star"></i></a>
                                    @endif



                                    <a href="{{ route('admin.app.sections.show', $item->id) }}" data-hover="@lang('admin.show')" class="btn btn-neutral text-info"><i class="bx bxs-show"></i></a>


                                    <a href="{{ route('admin.app.sections.edit',$item->id) }}" data-hover="@lang('admin.edit')" class="btn btn-neutral text-primary"><i class="bx bxs-edit"></i></a>
                        ...
                        @include('admin.layouts.delete', ['route'=> 'admin.app.sections.destroy'])
