...
@section('title', trans('sections.create_sections'))
...
<div class="card">
    <div class="card-body">
        ...
        <form action="{{ route('admin.app.sections.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-8">
                                ...
                                <div class="accordion-body">
                                    ...
                                    <div class="col-12">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-12">
                                                <input class="form-control" type="number" placeholder="@lang('sections.sort')" id="example-number-input" name="sort" value="{{ old('sort') }}">
                                            </div>
                                        </div>
                                    </div>
                                    {{-- feature ------------------------------------------------------------------------------------- --}}
