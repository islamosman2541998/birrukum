...
@section('title_page', trans('rites.edit_rites'))
                            ...
                            <div id="collapseOneq" class="accordion-collapse collapse show mt-3" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" type="text" name="{{ $locale }}[title]" value="{{ @$rites->trans->where('locale', $locale)->first()->title }}">
                                        </div>
                        ...
                        <div class="accordion-item border rounded">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-4">
                                            <a href="{{ getImage($rites->image) }}">
                                                <img src="{{ getImageThumb($rites->image) }}" alt="" width="50">
                                            </a>
                                        </div>
                                        <div class="col-8">
                                            <div class="col-sm-12">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-12">
                                            <select class="form-select select2" name="project_id" aria-label=".form-select-sm example">
                                                ...
                                                <option value="{{ $item->id }}" {{ $rites->project_id == $item->id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="row mb-3">
                                            <div class="col-6">
                                                <label for="example-sort-input" class="col-form-label"> @lang('articles.sort')</label>
                                            </div>
                                            <div class="col-9">
                                                <input class="form-control" type="number" id="example-sort-input" name="sort" value="{{ @$rites->sort }}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-5 mt-3">
                                            ...
                                            <div class="form-check form-switch form-check-success">
                                                <input class="form-check-input {{ (empty($errors->first('proof'))) ?: 'has-error'}}" type="checkbox" role="switch" name="proof" {{  @$rites->proof == 1 ? 'checked' : ''  }} id="flexSwitchCheckSuccessConfirm">
                                                @if ($errors->has('proof'))
                                        ...
                                        <div class="col-sm-5 mt-3">
                                            ...
                                            <div class="form-check form-switch form-check-success">
                                                <input class="form-check-input {{ (empty($errors->first('status'))) ?: 'has-error'}}" type="checkbox" role="switch" name="status" {{  @$rites->status == 1 ? 'checked' : '' }} id="flexSwitchCheckSuccessStatus">
