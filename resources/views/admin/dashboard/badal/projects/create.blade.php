...
<div class="card">
    <div class="card-body">
        <form action="{{ route('admin.badal.projects.store') }}" method="post" enctype="multipart/form-data" id="form-submit">
            @csrf
            <div>
                <div class="row">
                    <div class="col-md-8">
                                ...
                                <div id="collapseSetting" class="accordion-collapse collapse show" aria-labelledby="headingSetting" data-bs-parent="#accordionExampleSetting">
                                    <div class="accordion-body">
                                        ...
                                        <div class="mb-3 row title-section">
                                            ...
                                            <div class="col-sm-12">
                                                <select class="form-select form-select-sm select2 {{ (empty($errors->first('badal_type'))) ?: 'has-error'  }}" name="badal_type" aria-label=".form-select-sm example" required>
                                                    <option value="" disabled selected>@lang('charityProject.choose_type')</option>
                                                    @foreach (App\Enums\BadalTypeEnum::values() as $type)
                                                    <option value="{{ $type }}" {{ $type == (old('badal_type'))  ? 'selected' : '' }}>
                                                        {{ $type}}
                                                    </option>
                                                    @endforeach
                                                </select>
                                                @if ($errors->has('badal_type'))
                                                <span class="missiong-spam">{{ $errors->first('badal_type') }}</span>
                                                @endif
                                            </div>
                                        </div>
                                        {{-- category ------------------------------------------------------------------------------------- --}}
                                ...
                                <div id="payment_method" class="accordion-collapse collapse show" aria-labelledby="headingPayments" data-bs-parent="#accordionExamplePayments">
                                    <div class="accordion-body">
                                        ...
                                        <div class="mb-3 row title-section">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" name="donation_type" value="fixed"  class="form-select" readonly>
                                            </div>
                                        ...
                                        <div class="mb-3" id="section-fixed-value">
                                            <div class="col-12">
                                                <label for="example-number-input" class="col-sm-12 col-form-label">
                                        ...
                                        <div class="mb-3 mt-3 row">
                                            <div class="col-12">
                                                ...
                                                <div class="col-sm-12">
                                                    <input class="form-control {{ (empty($errors->first('min_price'))) ?: 'has-error'}}" type="number"  name="min_price" value="{{ old('min_price') ?? 0 }}" required>
                                                    @if ($errors->has('min_price'))
                                                    <span class="missiong-spam">{{ $errors->first('min_price') }}</span>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="row mb-3 text-end">
                    <div>
                        <a href="{{ route('admin.badal.projects.index') }}" class="btn btn-outline-primary waves-effect waves-light ml-3 btn-sm" id="chiledBack">@lang('button.cancel')</a>
