...
<div class="card">
    <div class="card-body">
        <form action="{{ route('admin.badal.projects.update', $project->id) }}" method="post" enctype="multipart/form-data" id="form-submit">
            @csrf
            @method('put')
            <div class="row">
                <div class="col-md-8">
                            ...
                            <div id="collapseOne{{ $key }}" class="mt-3 accordion-collapse collapse show" aria-labelledby="headingNames{{ $key }}" data-bs-parent="#accordionExampleNames{{ $key }}">
                                <div class="accordion-body">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-12">
                                            <input class="form-control" type="text" name="{{ $locale }}[title]" value="{{ @$project->trans->where('locale', $locale)->first()->title }}" id="title{{ $key }}" required>
                                    ...
                                    <div class="mb-3 row title-section">
                                        ...
                                        <div class="col-sm-12">
                                            <select class="form-select form-select-sm select2 {{ (empty($errors->first('badal_type'))) ?: 'has-error'  }}" name="badal_type" aria-label=".form-select-sm example" required>
                                                ...
                                                <option value="{{ $type }}" {{ $type == ($project->badalField?->badal_type)  ? 'selected' : '' }}>
                                                    {{ $type}}
                                                </option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="accordion-body">
                                    ...
                                    <div class="mb-3 mt-3 row">
                                        <div class="col-12">
                                            ...
                                            <div class="col-sm-12">
                                                <input class="form-control {{ (empty($errors->first('min_price'))) ?: 'has-error'}}" type="number"  name="min_price" value="{{  $project->badalField->min_price ?? 0 }}" required>
                ...
                <div class="mb-3 row text-end">
                    <div>
                        <a href="{{ route('admin.badal.projects.index') }}" id="chiledBack" class="ml-3 btn btn-outline-primary waves-effect waves-light btn-sm">@lang('button.cancel')</a>
