        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.roles.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control  @error('name') is-invalid @enderror" type="text" placeholder="@lang('admin.name')" name="name" value="{{ old('name') }}">
                        @error('name')
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        ...
                        <select id="permissions" class="form-control multi-select" multiple="multiple" required name="permissions[]">
                            ...
                            <option value="{{ $item->id }}">{{ transPermission($item->name) }} </option>
                            @endforeach
                ...
                <div class="row mb-3 text-end">
                    <div>
                        <a href="{{ route('admin.roles.index') }}" class="btn btn-primary waves-effect waves-light ml-3 btn-sm">@lang('button.cancel')</a>
