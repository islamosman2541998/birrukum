                ...
                <div class="col-lg-3 d-flex justify-content-center">
                  ...
                  @endphp
                    <a href="{{ route('site.home') }}" class="navbar-brand font-weight-bold pr-0 me-1">
                      <img src="{{ getImage($settings->getItem('logo')) ?? site_path('img/logo.png') }}" alt="namaa" height="100" class=" d-none d-lg-inline" />
                      <img src="{{ getImage($settings->getItem('logo')) ?? site_path('img/logo.png') }}" alt="namaa" height="40" class=" d-inline d-lg-none" />
                  </a>
                </div>
                        ...
                        <a href="{{ route('site.home') }}" class="home-icon shadow">
                          <svg  xmlns="http://www.w3.org/2000/svg"  width="21.624"  height="23.475"  viewBox="0 0 21.624 23.475" >
                            <g id="homeicon" transform="translate(-8769.442 -71.45)">
                              <path id="Path_8605" data-name="Path 8605"  d="M8772.3,81.531V94.383h4.985V86.67h5.938v7.713h4.984V81.531l-7.954-6.431Z"
                                fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.084" />
                              <path  id="Path_8606"  data-name="Path 8606" d="M8790.3,80.113l-10.05-8.121-10.049,8.121" fill="none"
                                stroke="#fff"  stroke-linecap="round" stroke-linejoin="round" stroke-width="1.084" />
                            </g>
                          </svg>
                        </a>
