    ...
    <div class="container bg-light mt-5 border-main">
        <div class="row gx-2">
            ...
            <div class="col-12 order-lg-2 order-2 col-lg-9 mx-auto">
                <div class="info row px-5 bg-white info   m-md-4 border-main">
                    <h1 class="col-12 fs-2 text-center mt-5" dir="rtl"> @lang('personal account information')</h1>
                    <div class="row personl_info mt-5 mb-3">
                        <p type="text" class="border-0 col-10 fs-4" dir="rtl" id=""> {{ $donor->full_name }}</p>
                        <i class="icofont-user-alt-3 col-2 fa-user-pen fs-2"></i>
                    </div>
                    <hr class="spater" />
                    <div class="row personl_info mt-2 mb-3">
                        <p type="text" class="border-0 col-10 fs-4" dir="rtl" id=""> {{ $donor->account->mobile }} </p>
                        <i class="icofont-phone fa-envelope col-2 fs-2 mt-2"></i>
                    </div>
                    <hr class="spater" />
                    <div class="row personl_info mt-2 mb-3">
                        <p type="text" class="border-0 col-10 fs-4" dir="rtl" id=""> {{ $donor->account->email }} </p>
                        <i class="icofont-envelope fa-envelope col-2 fs-2 mt-2"></i>
                    </div>
                    <div class="row m-3">
                        <a href="{{ route('site.profile.edit') }}" class="btn bg-main col-md-3 mx-auto col-12  text-white fs-6" dir="rtl">
                            @lang('Edit')
                        </a>
                    </div>
                </div>
