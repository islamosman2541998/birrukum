                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="col-md-7 text-center text-md-end col-12 mt-3">
                                    <h1 class="fs-4"> @lang('Edit Products') </h1>
                                </div>

                                <form action="{{ route('site.vendors.products.update', $product->id) }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    @method('put')
                                    <div class="row">
                                        <div class="col-md-12">
                                                    ...
                                                    <div id="collapseOne{{ $key }}" class="accordion-collapse collapse show mt-3" aria-labelledby="headingOne{{ $key }}" data-bs-parent="#accordionExample">
                                                        <div class="accordion-body">
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input class="form-control" type="text" name="{{ $locale }}[title]" value="{{ $product->trans->where('locale',$locale)->first()->title }}" id="title{{ $key }}" required />
                                                                </div>
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-10 mb-2">  
                                                                    <textarea id="description{{ $key }}" name="{{ $locale }}[description]" class="form-control" rows="5" > {{ $product->trans->where('locale',$locale)->first()->description }} </textarea>
                                                        ...
                                                        <div class="accordion-body">
                                                            <div class="row">
                                                                    ...
                                                                    <div class="row mb-3 title-section">
                                                                        ...
                                                                        <div class="col-sm-12">
                                                                            <select class="form-select form-select-sm" name="category_id" aria-label=".form-select-sm example" required>
                                                                                ...
                                                                                <option value="{{ $item->id }}" {{  $item->id == $product->category_id ? 'selected' : ''  }}> {{ $item->trans->where('locale', $current_lang)->first()->title }} </option>
                                                                                @endforeach
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="col-6">
                                                                    ...
                                                                    <div class="col-12">
                                                                        <div class="row mb-3">
                                                                            <label for="example-number" col-form-label> @lang('products.price')</label>
                                                                            <div class="col-sm-12">
                                                                                <input class="form-control" type="number" step="any" id="example-number" name="vendor_price" value="{{ @$product->vendor_price }}" required>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    {{-- sort ------------------------------------------------------------------------------------- --}}
                                                                    <div class="col-12">
                                                                        <div class="row mb-3">
                                                                            ...
                                                                            <div class="col-sm-12">
                                                                                <input class="form-control" type="number" id="example-number-sort" name="sort" value="{{ @$product->sort }}">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="accordion-body">
                                                            ...
                                                            <div class="col-12">
                                                                <div class="">
                                                                    ...
                                                                    <div class="glr-group row">
                                                                        <input id="galery" readonly name="image" class="form-control" type="text" value="{{ $product->image }}">
                                                            ...
                                                            <div class="col-12">
                                                                ...
                                                                <div class="row mb-3">
                                                                    ...
                                                                    <div class="col-sm-12">
                                                                        <input class="form-control" type="file" placeholder="@lang('admin.cover_image')" id="example-number-cover_image" name="cover_image" value="{{ old('cover_image') }}">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="row mb-3 text-end">
                                            <div>
                                                ...
                                                <button type="submit" name="submit" value="update" id="submit" class="btn btn-success waves-effect waves-light btn-sm">@lang('button.save_update')</button>
                                            </div>
                                        </div>
