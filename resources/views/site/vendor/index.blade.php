            ...
            <div class="col-12 order-lg-2 order-2 col-lg-9 mx-auto">
                <div class="info row px-3 bg-white m-md-4 border-main">
                    ...
                    <div class="row personl_info mt-5 mb-3">
                        <p type="text" class="border-0 col-10 fs-4" dir="rtl" id=""> {{ $vendor->responsible_person }}</p>
                        <i class="icofont-user-alt-3 col-2 fa-user-pen fs-2"></i>
                    </div>
                    <hr class="spater" />
                    <div class="row personl_info mt-2 mb-3">
                        <p type="text" class="border-0 col-10 fs-4" dir="rtl" id=""> {{ $vendor->account->mobile }} </p>
                        <i class="icofont-phone fa-envelope col-2 fs-2 mt-2"></i>
                    </div>
                    <hr class="spater" />
                    <div class="row personl_info mt-2 mb-3">
                        <p type="text" class="border-0 col-10 fs-4" dir="rtl" id=""> {{ $vendor->account->email }} </p>
                ...
                <div class="info  row px-5 bg-white m-md-5 border-main">
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <div class="numbers row py-2 mb-4" dir="rtl">
                                <div class="numerOfdonamtion col-md-5 col-12 me-1 bg-main rounded-3 text-center">
                                    ...
                                    <p class="fs-4" dir="rtl"> @lang('Number of orders') </p>
                                </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="numbers row py-2 mb-4" dir="rtl">
                                <div class="numerOfdonamtion col-md-12 col-12 me-1 bg-main rounded-3 text-center">
                                    <h1 class="fs-1 mt-3"> {{ count($products) }} </h1>
                                    <p class="fs-4" dir="rtl"> @lang('Number of Products') </p>
                                </div>
