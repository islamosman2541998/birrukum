...
namespace App\Http\Livewire\Admin\gifts\Categories;
...
class Index extends Component
{
    ...
    public function delete() {
        GiftCategories::findOrFail( $this->deleteId)->delete();
    ...
    public function publishSelected(){
        $items = GiftCategories::findMany($this->mySelected);
    ...
    public function render(){
        $query = GiftCategories::with(['trans']);
        ...
        return view('livewire.admin.gifts.categories.table', compact('items', 'links'));
    }
