...
namespace App\Http\Livewire\Admin\gifts\Occasions;
...
class Index extends Component
{
    ...
    public function render(){
        $query = GiftOccasioins::with(['trans']);
        ...
        return view('livewire.admin.gifts.occasions.table', compact('items', 'links'));
    }

    // delete selected item -------------------------------------------
    public function delete() {
        GiftOccasioins::findOrFail( $this->deleteId)->delete();
    ...
    public function publishSelected(){
        $items = GiftOccasioins::findMany($this->mySelected);
