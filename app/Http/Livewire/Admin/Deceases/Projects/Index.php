...
class Index extends Component
{
    ...
    public function mount(){
        ...
        $this->categories = CategoryProjects::with('trans')->descesd()->orderBy('created_at', 'DESC')->get();
    }
    ...
    public function render()
    {
        ...
        $query = CharityProject::with(['trans', 'category' ,'category.trans', 'decease'])->descesd()->orderBy('created_at', 'DESC');
        ...
        return view('livewire.admin.deceases.projects.index', compact('items', 'links', 'categories'));
    }
